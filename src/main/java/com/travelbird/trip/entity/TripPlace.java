...
public class TripPlace {
  ...
  static TripPlace create(Trip trip,TripDay day,Long placeId,int order){var p=new TripPlace();p.trip=trip;p.day=day;p.placeId=placeId;p.visitOrder=order;return p;}
  ...
  public void updateContent(String memo,List<Long> fileIds){this.memo=memo;this.images.clear();for(int i=0;i<fileIds.size();i++)this.images.add(TripPlaceImage.create(this,fileIds.get(i),i));}
}
